...
def evaluate():
    ...
    cfg.FOLDER = cfg.TEST.FOLDER  # output dir
    ...
    # Dataset
    datamodule = build_data(cfg)  # cfg.DATASET.  by default, it's HumanML3DDataModule
    ...
    # Model
    model = build_model(cfg, datamodule)   ## cfg.MODEL init motionGPT here
    ...
    elif cfg.TEST.CHECKPOINTS.endswith(".tar"):
        metric_file = cfg.TEST.CHECKPOINTS.replace(".tar", "-temp-{}-metrics.json".format(cfg.TEMPERATURE))
