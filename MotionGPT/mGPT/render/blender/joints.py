...
class Joints:
    ...
    def get_sequence_mat(self, frac):
        def interp_mat(mat, t):
            ...
            # rgbs = np.clip(rgbs * 3.0, 0.0, 1.0)
            mats = [
                colored_material_diffuse_BSDF(*(t**4 * rgb), a=1, roughness=0.6)
                for rgb in rgbs
            ]
        ...
        t = begin + (end-begin)*frac
        return interp_mat(self.mat, t)
    
    def get_sequence_mat_old(self, frac):
        return self.mat
