...
def parse_args(phase="train"):
    ...
    if phase in ["train", "test"]:
        ...
        group.add_argument("--peft", 
                           action="store_true",
                           required=False,
                           help="debug or not")
        
        # cfg.r, lora_alpha=cfg.lora_alpha, lora_dropout=cfg.lora_dropout
        ...
        group.add_argument("--temperature",
                            ...
                            required=False,
                            help="temperature")
        group.add_argument("--eval_examples",   
                            type=str,
                            required=False,
                            default=None,
                            help="evaluation examples")
    ...
    if phase == "render":
        ...
        group.add_argument(
            ...
            type=int,
            default=0,
            help="start index of the group you want to render"
        )
        group.add_argument(
            "--end",
            type=int,
            default=10,
            help="index index of the group you want to render"
        )
        group.add_argument("--device",
            type=int,
            nargs="+",
    ...
    if phase in ["train", "test"]:
        ...
        ### 
        cfg.TEST.CHECKPOINTS = params.checkpoint if params.checkpoint else cfg.TEST.CHECKPOINTS
        ### 
        cfg.PEFT = params.peft
        cfg.LORA_R = params.r
        cfg.LORA_ALPHA = params.lora_alpha
        cfg.LORA_DROPOUT = params.lora_dropout
        cfg.TEMPERATURE = params.temperature
        print("SETTING TEMPERATURE TO ", cfg.TEMPERATURE)
        cfg.PROMPTS = params.eval_examples
    ...
    if phase == "render":
        ...
        cfg.RENDER.OUTPUT_DIR = params.output_dir
