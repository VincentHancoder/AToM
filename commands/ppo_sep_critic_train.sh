...
OUTPUT_DIR="${ROOT_PATH}/outputs/ppo/model_critic"
MODEL_NAME="${ROOT_PATH}/MotionGPT/deps/flan-t5-base"
REWARD_MODEL_PATH="${ROOT_PATH}outputs/ppo/rm/epoch20.0_seed42_bs32_lr0.0002_marginTruebig_neftune0.1_wd0.0_unsureFalse_skippedFalse/checkpoint-1180"
