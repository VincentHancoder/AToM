...
def main(script_args):
    ...
    preference_data_folder = "pref_data/general_preference"

    print("---------------")
    print(f"Using preference data set {preference_data_folder}")
    print("---------------")

    script_args.jsonl_path="{}/{}/preference_labels.jsonl".format(script_args.root_path, preference_data_folder)
    script_args.data_root_path = "{}/{}".format(script_args.root_path, preference_data_folder)
    script_args.pretrain_ckpt_path = "{}/MotionGPT/checkpoints/MotionGPT-base/motiongpt_s3_h3d.tar".format(script_args.root_path)
