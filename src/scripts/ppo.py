...
def main(args):
    ...
    # args.data_root_path = "{}/data/preference_data_origin".format(args.root_path)
    args.data_root_path = args.preference_data_dir
    args.jsonl_path=os.path.join(args.data_root_path, "preference_labels.jsonl")
    ...
    for epoch in range(args.epochs):
        ...
        if ppo_trainer.accelerator.is_main_process and not args.debug_mode and (epoch+1) % 5 == 0:
            evaluate_during_training(ppo_trainer, model, run_name, epoch+1, step_cnt, args)
