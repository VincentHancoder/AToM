...
class ScriptArguments:
    ...
    preference_data_dir: str = field(default=".", metadata={"help": "path to the preference data"})
...
def main(args):
    ...
    # args.data_root_path = f"{args.root_path}/data/preference_data_origin"
    args.data_root_path = args.preference_data_dir
    args.dataset_path = os.path.join(args.data_root_path, "preference_labels.jsonl")
